  ...
  return (
    <div className='n-bg-palette-neutral-bg-weak flex flex-col justify-between min-h-full max-h-full overflow-hidden'>
                    ...
                    {chat.user === 'chatbot' &&
                      ...
                      !chat.isTyping && (
                        <div className='flex inline-block'>
                          ...
                          >
                          ...
                          </IconButtonWithToolTip>                          {copyMessageId === chat.id && (
                            <>
                              <span className='pt-4 text-xs'>已复制！</span>
                            ...
                            label={chat.speaking ? '停止朗读' : '文本转语音'}
                          >
                            {chat.speaking ? (
      ...
      <div className='n-bg-palette-neutral-bg-weak flex gap-2.5 bottom-0 p-2.5 w-full'>
        <form onSubmit={handleSubmit} className='flex gap-2.5 w-full'>          <TextInput
